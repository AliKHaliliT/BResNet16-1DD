import unittest
from BResNet161DD.bresnet16_1dd import BResNet161DD
import tensorflow as tf
import inspect


class TestBResNet161DD(unittest.TestCase):
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(BResNet161DD.__init__).parameters.values()
    ...
    def test_from__config_config__dict_inputted__config__dict(self):
        ...
        # Act
        cloned = BResNet161DD.from_config(model.get_config())
